...
export default {
    ...
    data: () => ({
        work: [
            ...
            {
                time: 'Jul 2022-Feb 2025', employer: 'Arizona State University', place: 'Tempe, AZ', duties: 'Developed a 25000 FPS radio camera to detect Fast Radio Bursts (FRBs) below 100 MHZ', position: 'Postdoc', color: 'orange'
            },
            {
                time: 'March 2025-Present', employer: 'Caltech', place: 'Pasadena, CA', duties: 'Develop and optimize GPU modules for the Radio Camera on DSA-2000 project.', position: 'GPU Engineer', color: 'blue'
            }
        ].reverse()
    })
}
